...
var PDF = /*#__PURE__*/function (_Webform) {
  ...
  _createClass(PDF, [{
    ...
    value: function setAlert(type, message, classes) {
      _get(_getPrototypeOf(PDF.prototype), "setAlert", this).call(this, type, message, classes);

      var buttonTop = this.refs.button.offsetTop;
    ...
    key: "checkSubmitButtonHiddenness",
    value: function checkSubmitButtonHiddenness() {
      var hidden = false;
