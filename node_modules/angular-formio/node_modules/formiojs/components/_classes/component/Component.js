...
var QUILL_URL = 'https://cdn.quilljs.com/2.0.0-dev.3';
...
var Component = /*#__PURE__*/function (_Element) {
  ...
  _createClass(Component, [{
    ...
    value: function getModalPreviewTemplate() {
      return "\n      <label class=\"control-label\">".concat(this.component.label, "</label><br>\n      <button lang='en' class='btn btn-light btn-md open-modal-button' ref='openModal'>").concat(this.getValueAsString(this.dataValue) || this.t('Click to set value'), "</button>");
    }
  }, {
    key: "build",
    ...
    value: function attach(element) {
      ...
      if (!this.builderMode && this.component.modalEdit) {
        ...
        this.componentModal = new _ComponentModal.default(this, element, modalShouldBeOpened);
        ...
        if (Array.isArray(refreshOn)) {
          refreshOn.forEach(function (refreshData) {
            return changes.forEach(function (changed) {
              return _this6.checkRefresh(refreshData, changed);
            });
          });
        } else {
          changes.forEach(function (changed) {
            return _this6.checkRefresh(refreshOn, changed);
          });
        }
      }
    }
    ...
    value: function calculateComponentValue(data, flags, row) {
      ...
      var calculatedValue = this.evaluate(this.component.calculateValue, {
        ...
        data: data,
        row: row || this.data
      }, 'value') || this.emptyValue; // reassigning calculated value to the right one if rows(for ex. dataGrid rows) were reordered
      ...
      if (_lodash.default.isEqual(normCurr, normNew)) {
        return false;
      }
