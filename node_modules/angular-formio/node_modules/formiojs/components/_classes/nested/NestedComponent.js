...
var NestedComponent = /*#__PURE__*/function (_Field) {
  ...
  _createClass(NestedComponent, [{
    ...
    value: function getComponent(path, fn, originalPath) {
      ...
      var pathStr = originalPath || (0, _utils.getStringFromComponentPath)(path);
    ...
    value: function setNestedValue(component, value) {
      ...
      if (component.type === 'components') {
        ...
        return component.defaultValue ? component.setValue(component.defaultValue, flags) : component.setValue(_lodash.default.get(value, component.key), flags);
