  ...
  _createClass(EditGridComponent, [{
    ...
    value: function addRowModal(rowIndex) {
      ...
      dialog.refs.dialogContents.appendChild(this.ce('button', {
        ...
        onClick: function onClick() {
          if (_this6.validateRow(editRow, true) || _this6.component.rowDrafts) {
    ...
    value: function updateRowsComponents(rowIndex) {
      ...
      this.editRows.slice(rowIndex).forEach(function (row, index) {
        _this7.updateComponentsRowIndex(row.components, index);
      });
    }
  }, {
    key: "baseRemoveRow",
    ...
    value: function createRowComponents(row, rowIndex) {
      ...
      return this.component.components.map(function (col, colIndex) {
        ...
        var options = _lodash.default.clone(_this8.options);
        ...
        options.onChange = function (flags, changed, modified) {
          ...
          if (_this8.inlineEditMode) {
            _this8.triggerRootChange(flags, changed, modified);
          } else if (editRow) {
            _this8.checkRow('checkData', null, _objectSpread(_objectSpread({}, flags), {}, {
              changed: changed
            }), editRow.data, editRow.components);
          }
        };

        var comp = _this8.createComponent(_lodash.default.assign({}, column, {
          row: options.row
        }), options, row);
    ...
    value: function validateRow(editRow, dirty) {
      ...
      if (!valid) {
        editRow.errors = this.errors.filter(function (err) {
    ...
    value: function setValue(value) {
      ...
      this.dataValue.forEach(function (row, rowIndex) {
        ...
        if (editRow) {
          ...
          _this10.restoreRowContext(editRow, flags);

          editRow.state = EditRowState.Saved;
          editRow.backup = null;
          editRow.error = null;
        } else {
          _this10.editRows[rowIndex] = {
            components: _this10.createRowComponents(row, rowIndex),
            data: row,
            state: EditRowState.Saved,
            backup: null,
            error: null
      ...
      this.editRows.slice(dataLength).forEach(function (editRow, index) {
        return _this10.baseRemoveRow(dataLength + index);
      });
    ...
    value: function restoreRowContext(editRow) {
      ...
      editRow.components.forEach(function (component) {
        ...
        _this11.setNestedValue(component, editRow.data, flags);
      });
    }
  }]);
