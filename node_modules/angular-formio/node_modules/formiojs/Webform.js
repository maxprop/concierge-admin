  ...
  _createClass(Webform, [{
    ...
    value: function setForm(form, flags) {
      ...
      return rebuild.then(function () {
        ...
        var resolveForm = function resolveForm(flags) {
    ...
    value: function setValue(submission) {
      ...
      submission.data = submission.data ? _objectSpread(_objectSpread({}, this.data), submission.data) : this.data;
