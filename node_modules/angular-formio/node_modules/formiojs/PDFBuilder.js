...
var PDFBuilder = /*#__PURE__*/function (_WebformBuilder) {
  ...
  _createClass(PDFBuilder, [{
    ...
    value: function onDragEnd(e) {
      ...
      this.emit('addComponent', schema, this.webform, schema.key, this.webform.component.components.length, !this.options.noNewEdit); // Delete the stored drop event now that it's been handled
