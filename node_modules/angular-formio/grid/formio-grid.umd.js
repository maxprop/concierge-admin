(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/router'), require('formiojs'), require('rxjs'), require('lodash'), require('formiojs/utils/Evaluator'), require('@angular/elements'), require('ngx-bootstrap/pagination')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/router', 'formiojs', 'rxjs', 'lodash', 'formiojs/utils/Evaluator', '@angular/elements', 'ngx-bootstrap/pagination'], factory) :
    (global = global || self, factory(global['formio-grid'] = {}, global.core, global.common, global.forms, global.router, global.formiojs, global.rxjs, global.lodash, global.Evaluator, global.elements, global.pagination));
}(this, (function (exports, core, common, forms, router, formiojs, rxjs, lodash, Evaluator, elements, pagination) { 'use strict';

    Evaluator = Evaluator && Object.prototype.hasOwnProperty.call(Evaluator, 'default') ? Evaluator['default'] : Evaluator;
    ...
    var FormioGridComponent = /** @class */ (function () {
        ...
        FormioGridComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<ng-template #headerTemplate></ng-template> <ng-template #bodyTemplate></ng-template> <ng-template #footerTemplate></ng-template> <div class=\"formio-grid\"> <formio-alerts [alerts]=\"alerts\"></formio-alerts> <table class=\"table table-bordered table-striped table-hover\"> <ng-container *ngIf=\"initialized\" [ngTemplateOutlet]=\"header.template\"></ng-container> <formio-loader [isLoading]=\"isLoading\"></formio-loader> <ng-container *ngIf=\"initialized\" [ngTemplateOutlet]=\"body.template\"></ng-container> <ng-container *ngIf=\"initialized\" [ngTemplateOutlet]=\"footer.template\"></ng-container> </table> </div> "
                    },] },
        ];
        /** @nocollapse */
